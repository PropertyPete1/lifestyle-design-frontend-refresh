  ...
  return (
    <div className="activity-tracker-container">
      ...
      <style jsx>{`
        ...
        .activity-heatmap { display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 2rem 1rem; width: min(1100px, 100vw - 32px); margin: 0 auto; overflow-x: hidden; }
